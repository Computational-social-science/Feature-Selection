...
methodsname = ['EAMB']#,,,,'FBED','LRH''IAMB','Inter_IAMB','Fast_IAMB'
methods = [EAMB]#,,,,FBEDLRHIAMB,Inter_IAMB,Fast_IAMBFBED,LRH,IAMB,Inter_IAMB,Fast_IAMB
...
datasets = [ 'SRBCT','spambase','splice','Synthetic_control', 'TOX_171', 'Waveform','Wdbc',  'WarpPIE10P', 'Yeoh', 'Yale', ]#
base_url = r"../dataset/"
import numpy as np
