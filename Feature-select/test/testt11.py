...
# datasets = [ 'Factors', 'Pixel', 'Isolet','ORL', 'WarpPIE10P', 'Su',
        ...
        if fold > 5 and fold < 7:
            ...
            for nowy in Class:
                if nowy > 1:
                    ...
                    # 保存为 JSON 文件
                    file_name = r"../feature_select_result/EAMB11" +'/' + dataname + "_sp_result" + str(fold) + ".txt"
