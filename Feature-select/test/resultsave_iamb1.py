...
# ====================================数据导入=====================================
#'Yeoh','Waveform','Wdbc', 'Synthetic_control','Authorship', 'Factors', 'Pixel', 'Isolet','ORL', 'WarpPIE10P', 'Su',
            # 'Prostate_GE', 'TOX_171', 'Orlraws10P', 'Yeoh','Musk1', 'Sorlie', 'Yale', 'WarpAR10P', 'GLIOMA', 'Arcene',
# datanames = ['CLL_SUB_111',]#'Movement_libras',
...
for dataname in datanames:
    ...
    for fold, (train_index, test_index) in enumerate(kfold.split(X, y)):  # fold赋值之后就是0-9
        ...
        # -----------------otherway
        file_name = r"feature_select_result/" + 'IAMB' + '/' + dataname + str(fold) + "_result-f.txt"
...
f1table.to_excel('tables/' + '/auctable_iambf.xlsx', index=True)
