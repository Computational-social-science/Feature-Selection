...
# datanames = ['Dermatology','Movement_libras','Musk1','Synthetic_control','Waveform','Wdbc','Arcene','CLL_SUB_111','GLIOMA', 'Isolet', 'ORL','Orlraws10P', 'Prostate_GE', 'TOX_171','WarpAR10P', 'WarpPIE10P',  'Yale',  'Authorship', 'Factors','Pixel', 'Sorlie','Su',  'Yeoh']#,]
#  #
...
for dataname in datanames:
    ...
    for fold, (train_index, test_index) in enumerate(kfold.split(X, y)):  # fold赋值之后就是0-9
        ...
        # -----------------otherway
        file_name = r"feature_select_result/" + 'eamb' + '/' + dataname  + "_result.txt"
...
f1table.to_excel('tables/' + '/auctable_eamb_new.xlsx', index=True)
