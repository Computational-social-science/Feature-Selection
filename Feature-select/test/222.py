...
# datasets = []
datasets = ['ORL', 'WarpPIE10P',
            'Prostate_GE', 'TOX_171', 'CLL_SUB_111','Yeoh', 'Yale', 'WarpAR10P', 'GLIOMA', 'Arcene','Orlraws10P', ]#
#
# base_url = r"./dataset/"
# import numpy as np
#
...
for dataname in datasets:
    ...
    print(count)
    count.to_excel('tables/' + 'lrhsp1CIcount.xlsx', index=True)
