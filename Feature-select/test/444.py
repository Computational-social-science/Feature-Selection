...
# #   s = ['Yale', 'WarpAR10P', 'GLIOMA', 'Arcene','Orlraws10P', ]#
#
# base_url = r"./dataset/"
# impor          'Prostate_GE', 'TOX_171','CLL_SUB_111','Yeoh','Musk1', 'Sorlie', 'Yale', 'WarpAR10P', 'GLIOMA', 'Arcene',
# # datasets = []
# datasett numpy as np
#
...
for dataname in datasets:
    ...
    print(count)
    count.to_excel('tables/' + 'lrhsp2CIcount.xlsx', index=True)
