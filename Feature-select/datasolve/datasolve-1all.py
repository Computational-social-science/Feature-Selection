...
def changetosinge(x):
    return float(x)
#读取数据
datasets = [ 'Wdbc', 'Su','Synthetic_control','Authorship', 'Factors', 'Pixel', 'Isolet', 'Yale', 'Yeoh', 'WarpAR10P', 'GLIOMA', 'Arcene', 'ORL', 'WarpPIE10P',
            'Prostate_GE', 'TOX_171', 'Orlraws10P', 'CLL_SUB_111','Dermatology','Waveform','Musk1', 'Sorlie', 'Movement_libras',]#
base_url = r"./dataset/"
