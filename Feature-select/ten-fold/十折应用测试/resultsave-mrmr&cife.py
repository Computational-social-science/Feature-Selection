...
def csmdccmrtest(time, result, X_test, y_test, X_train, y_train):
    for i in range(time):
        ...
        for item in nowpick:
            ...
            b10auc.append(rprobabilities)
            k10auc.append(rprobabilities)
            s10auc.append(rprobabilities)
        ...
        bpredict_probabity.append(b10auc)
    ...
    file_name1 = r"result/" + dataname + '_' + method + "predict_pro.mat"
    file_name2 = r"result/" + dataname + '_' + method + "predict_lable.mat"
...
def othertest(time, result, X_test, y_test, X_train, y_train):
    ...
    for i in range(time):
        ...
        bpredict_probabity.append(bprobabilities)
        kpredict_probabity.append(kprobabilities)
        spredict_probabity.append(sprobabilities)
        rpredict_probabity.append(rprobabilities)
        bpredict_labels.append(bpredicted_labels)
        kpredict_labels.append(kpredicted_labels)
        spredict_labels.append(spredicted_labels)
        rpredict_labels.append(rpredicted_labels)
