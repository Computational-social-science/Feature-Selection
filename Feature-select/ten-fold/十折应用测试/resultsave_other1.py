...
#'Dermatology',
datanames = ['ORL', ]#
            #'Prostate_GE', 'TOX_171', 'Orlraws10P', 'CLL_SUB_111', 'Yale', 'WarpAR10P', 'GLIOMA', 'Arcene', 'Waveform','Wdbc', 'Synthetic_control','Authorship', 'Musk1', 'Factors', 'Pixel', 'Isolet', 'Su','Sorlie', 'Movement_libras','Yeoh','WarpPIE10P',
base_url = r"./dataset/"
