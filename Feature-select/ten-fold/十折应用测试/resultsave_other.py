...
# ====================================数据导入=====================================
#'Dermatology',
datanames = ['Waveform','Wdbc', 'Synthetic_control','Authorship', 'Musk1', 'Factors', 'Pixel', 'Isolet', 'Su','Sorlie', 'Movement_libras','Yeoh']#,'Prostate_GE', 'TOX_171', 'Orlraws10P', 'CLL_SUB_111', 'Yale', 'WarpAR10P', 'GLIOMA', 'Arcene',  'ORL', 'WarpPIE10P','Dermatology',
            #
base_url = r"./dataset/"
