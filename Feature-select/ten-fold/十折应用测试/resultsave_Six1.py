...
# ====================================数据导入=====================================
#'Musk1','Sorlie','Factors','Yale','Movement_libras','WarpAR10P','GLIOMA','Waveform','Wdbc','Synthetic_control','WarpPIE10P','Prostate_GE','Dermatology','Arcene','CLL_SUB_111','Su','Yeoh','Isolet','Orlraws10P','Authorship','Pixel','TOX_171',
datanames = ['ORL',
]#
base_url = r"./dataset/"
